...
<header className="relative bg-gradient-to-br from-[#1e293b] via-[#22304a] to-[#111827] shadow-xl border-b border-cyan-700/60 backdrop-blur-lg">
  ...
  <div className="relative max-w-7xl mx-auto py-4 sm:py-5 px-4 sm:px-6 md:px-8 flex items-center justify-between">
    {/* Left: Heart Icon */}
    ...
    <div className="flex-1 flex justify-center">
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white tracking-tight bg-gradient-to-r from-white via-cyan-100 to-white bg-clip-text text-transparent drop-shadow-md text-center">
