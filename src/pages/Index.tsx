      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <section className="mb-10">
          ...
          <p className="text-gray-400">
            Upload your ECG image to detect abnormalities using advanced AI
            models. Our system provides a comprehensive analysis by combining
        ...
        <section className="mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0f1729] p-4 rounded-lg shadow-sm border border-gray-800">
              ...
              <p className="text-gray-400 text-sm">
                Our system analyzes your ECG using multiple specialized AI
            ...
            <div className="bg-[#0f1729] p-4 rounded-lg shadow-sm border border-gray-800">
              ...
              <p className="text-gray-400 text-sm">
                Receive detailed analysis with combined insights from all models
      ...
      <footer className="bg-[#0f1729] mt-16 border-t border-gray-800">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <p className="text-center text-gray-500 text-sm">
            Multi-Model ECG Analyzer © {new Date().getFullYear()} | Advanced ECG
            Analysis with AI
          </p>
        </div>
      </footer>
